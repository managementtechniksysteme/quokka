...
class FlowMeterInspectionReportUpdateRequest extends FormRequest
{
    public function rules(): array
    {
        $flow_meter_inspection_report = $this->flow_meter_inspection_report;
        ...
        $rules = [
            ...
            'inspected_on' => [
                ...
                Rule::unique('flow_meter_inspection_reports')
                    ...
                    ->ignore($flow_meter_inspection_report),
            ],
