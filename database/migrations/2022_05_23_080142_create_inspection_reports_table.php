...
class CreateInspectionReportsTable extends Migration
{
    public function up()
    {
        Schema::create('inspection_reports', function (Blueprint $table) {
            ...
            $table->double('uvc_lamp_uv_intensity_arrival');
            $table->double('uvc_lamp_uv_intensity_departure');
            ...
            $table->double('uvc_sensor_pre_alarm');
            $table->double('uvc_sensor_cut_off_point');
            ...
            $table->double('water_flow_rate');
            $table->double('water_minimum_uv_transmission');
            $table->double('water_measured_uv_transmission');
            $table->text('comment');
