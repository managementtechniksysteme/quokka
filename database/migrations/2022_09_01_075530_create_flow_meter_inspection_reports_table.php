...
class CreateFlowMeterInspectionReportsTable extends Migration {
    public function up()
    {
        Schema::create('flow_meter_inspection_reports', function (Blueprint $table) {
            ...
            $table->double('profile_outer_diameter');
            $table->double('profile_wall_thickness');
            ...
            $table->double('measuring_pipe_minimum_speed')->nullable();
            $table->enum('measuring_pipe_minimum_speed_unit', ['m_s'])->nullable();
            $table->double('measuring_pipe_maximum_speed')->nullable();
            $table->enum('measuring_pipe_maximum_speed_unit', ['m_s'])->nullable();
            $table->double('measuring_pipe_maximum_flow_rate')->nullable();
            $table->enum('measuring_pipe_maximum_flow_rate_unit', ['l_s', 'm3_h'])->nullable();
            $table->double('mucus_suppression')->nullable();
            ...
            $table->double('measurement_transformer_minimum_level')->nullable();
            $table->double('measurement_transformer_maximum_level')->nullable();
            $table->enum('measurement_transformer_level_unit', ['mA', 'V', 'interface']);
            $table->double('measurement_transformer_range_100_percent');
            ...
            $table->double('measurement_section_slope')->nullable();
            ...
            $table->double('measurement_section_minimum_speed_undercut_point')->nullable();
            ...
            $table->double('tailwater_runout_section_slope')->nullable();
            ...
            $table->double('zero_flow_rate_displayed_flow')->nullable();
            ...
            $table->double('comparison_measurement_mobile_equipment_maximum_speed')->nullable();
            $table->enum('comparison_measurement_mobile_equipment_maximum_speed_unit', ['m_s'])->nullable();
            $table->double('comparison_measurement_mobile_equipment_maximum_flow_rate')->nullable();
            $table->enum('comparison_measurement_mobile_equipment_maximum_flow_rate_unit', ['l_s', 'm3_h'])->nullable();
            $table->double('comparison_measurement_mobile_equipment_q_min')->nullable();
            ...
            $table->double('measurement_difference_up_to_30_q_max');
            $table->double('measurement_difference_above_30_q_max');
            $table->double('reading_difference_up_to_30_q_max');
            $table->double('reading_difference_above_30_q_max');
