    ...
    <div class="q-container">
        ...
        <form class="q-form needs-validation" enctype="multipart/form-data" action="{{ route('additions-reports.store') }}" method="post" novalidate>
            ...
            <div class="q-form-actions">
                <a class="btn q-btn d-inline-flex align-items-center gap-2" href="{{ route('additions-reports.index') }}"><svg class="icon-bs icon-16"><use href="{{ asset('svg/bootstrap-icons.svg') }}#x"></use></svg>Abbrechen</a>
