...
@section('mobile-detail-bar')
    ...
    <span class="q-appbar__title">{{ $additionsReport->project->name }} #{{ $additionsReport->number }}</span>
@endsection
        ...
        <div class="q-page-head d-none d-md-flex">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <h1 class="q-title">Regiebericht senden</h1>
                </div>
            </div>
        </div>

        <form class="q-form needs-validation mt-2 mt-md-4" action="{{ route('additions-reports.email', ['additions_report' => $additionsReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
