...
@section('content')
    <div class="q-container">
        ...
        <form class="q-form needs-validation mt-4" action="{{ route('additions-reports.email', ['additions_report' => $additionsReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
