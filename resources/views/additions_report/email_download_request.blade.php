...
@section('content')
    <div class="q-container">
        ...
        <form class="q-form needs-validation mt-2 mt-md-4" action="{{ route('additions-reports.email-download-request', ['additions_report' => $additionsReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
