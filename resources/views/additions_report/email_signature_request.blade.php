...
@section('content')
    <div class="bg-gray-100 mt-0">
        <div class="container py-4">
            ...
            <h3>
                Regiebericht Anfrage zur Unterschrift senden
    ...
    <div class="container my-4">
        <form class="needs-validation mt-4" action="{{ route('additions-reports.email-signature-request', ['additions_report' => $additionsReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
