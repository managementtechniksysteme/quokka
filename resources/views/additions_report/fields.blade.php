...
<div class="q-form-section">
    <div class="q-form-section__head">
        Stammdaten
        <div class="q-form-section__desc">Die Stammdaten des Regieberichtes. Bei der Bearbeitung eines bereits unterschriebenen Regieberichtes wird die vorhandene Unterschrift entfernt.</div>
    </div>
    <div class="q-form-section__body d-flex flex-column gap-3">
        ...
        <div>
            ...
            @if(optional($additionsReport)->status === 'signed')
                <div class="q-banner">
                    <svg class="icon-bs icon-16"><use href="{{ asset('svg/bootstrap-icons.svg') }}#exclamation-triangle"></use></svg>
                    <span>Der Regiebericht wurde bereits unterschrieben. Beim Speichern wird die aktuelle Unterschrift entfernt! Eine erneute Anfrage zum Unterschreiben kann gesendet werden.</span>
                </div>
            @endif
            <div class="btn-group">
    ...
    <div class="q-form-section__body d-flex flex-column gap-3">
        <div>
            ...
            <div class="btn-group @error('weather') is-invalid @enderror">
                ...
                <input type="radio" class="btn-check" name="weather" id="weather-rainy" value="rainy" autocomplete="off" @if(old('weather', optional($additionsReport)->weather) == 'rainy') checked @endif>
                <label class="btn btn-outline-secondary q-seg--sky" for="weather-rainy">regnerisch</label>
                <input type="radio" class="btn-check" name="weather" id="weather-snowy" value="snowy" autocomplete="off" @if(old('weather', optional($additionsReport)->weather) == 'snowy') checked @endif>
...
<div class="q-form-section">
    ...
    <div class="q-form-section__body">
        <markdown-editor name="comment" placeholder="Leistungsfortschritt" value="{{ old('comment', optional($additionsReport)->comment) }}" :employees="{{ $employees }}" v-cloak></markdown-editor>
...
<div class="q-form-section">
    <div class="q-form-section__head">
        Anhänge
        <div class="q-form-section__desc">Dem Regiebericht zugeordnete Anhänge. Erlaubt sind Dateien im Bildformat oder PDF Dokumente.</div>
    </div>
    <div class="q-form-section__body">
