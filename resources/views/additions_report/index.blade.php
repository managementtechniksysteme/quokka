            ...
            <div class="d-none d-md-flex flex-wrap align-items-center gap-3 mb-3">
                <form class="flex-grow-1" action="{{ route('additions-reports.index') }}" method="get">
                    ...
                    <div class="input-group">
                        <filter-search-input name="search" input_class="form-control" :fields="{{ json_encode($filterFields) }}" suggestions_url="{{ route('filter-suggestions.search') }}" model="additions_report" initial_value="{{ Request::get('search') ?? '' }}" placeholder="Regieberichte suchen"></filter-search-input>
            ...
            <div class="d-flex d-md-none align-items-center gap-2 mb-3">
                <form class="flex-grow-1" action="{{ route('additions-reports.index') }}" method="get">
                    ...
                    <div class="position-relative flex-grow-1">
                        <div class="input-group">
                            <filter-search-input name="search" input_class="form-control ps-5" :fields="{{ json_encode($filterFields) }}" suggestions_url="{{ route('filter-suggestions.search') }}" model="additions_report" initial_value="{{ Request::get('search') ?? '' }}" placeholder="Regieberichte suchen"></filter-search-input>
                            @if (Request::get('search'))
