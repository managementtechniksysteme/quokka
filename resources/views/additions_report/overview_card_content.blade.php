        ...
        <div class="mw-100 d-flex flex-grow-1 p-3 align-items-center">
                    ...
                    <div class="d-inline-flex align-items-center">
                        ...
                        @switch($additionsReport->status)
                            ...
                            @case('finished')
                                ...
                                @if($additionsReport->activities->last())
                                    ({{ Str::upper($additionsReport->activities->last()->causer->username) }})
                                @endif
                                @break
                        @endswitch
                        <svg class="icon icon-16 ms-2 me-1">
            ...
            <div class="d-none d-md-block ms-2">
                <div class="dropdown d-inline">
                    <button class="btn btn-lg btn-link dropdown-toggle-vertical-points text-muted" type="button" id="additionsReportOverviewDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>

                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="additionsReportOverviewDropdown">
