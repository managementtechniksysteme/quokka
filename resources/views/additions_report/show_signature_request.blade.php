...
@section('mobile-detail-bar')
    <a href="{{ route('additions-reports.show', $additionsReport) }}" class="q-appbar__btn" aria-label="Zurück">
        <svg class="icon-bs icon-20"><use href="{{ asset('svg/bootstrap-icons.svg') }}#chevron-left"></use></svg>
    </a>
    <span class="q-appbar__title">Regiebericht #{{ $additionsReport->number }}</span>
@endsection
                    ...
                    <form action="{{ route('additions-reports.sign', ['additions_report' => $additionsReport, 'redirect' => request()->redirect]) }}" method="post">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <button type="submit" class="btn btn-primary text-white d-inline-flex align-items-center gap-2">
                                ...
                                <span class="d-none d-md-inline">Regiebericht unterschreiben</span>
