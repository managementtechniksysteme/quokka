    ...
    <div class="q-container">
        ...
        <div class="d-flex flex-column gap-3">
            <div class="q-card text-center" style="padding: 2.5rem 1.5rem;">
                ...
                <p class="lead text-muted mt-2 mb-0">Vielen Dank, dass Sie den Regiebericht unterschrieben haben.</p>
            </div>

            <div class="q-card">
                <div class="q-card__head">Regiebericht herunterladen</div>
                <div class="q-card__body">
                    <p class="text-muted">Klicken Sie auf folgenden Button, um den Regiebericht im PDF Format zur Archivierung herunterzuladen.</p>

                    <a class="btn btn-primary text-white d-inline-flex align-items-center gap-2" href="{{ route('additions-reports.customer-download', $additionsReport->downloadRequest->token) }}">
                    ...
                    <p class="text-muted">Alternativ können Sie sich einen Link zum Herunterladen per Email schicken lassen, falls Sie den Regiebericht auf einem anderen Gerät herunterladen möchten. Geben Sie hierzu bitte die gewünschte Email Adresse in folgendes Feld ein und klicken anschließend auf den Button.</p>
