<div class="q-container">
    <div class="q-card text-center" style="padding: 2.75rem 1.5rem;">
        ...
        <p class="lead text-muted mt-2 mb-0">
            Unter diesem Link ist kein Regiebericht zur Unterschrift und zum Herunterladen vorhanden.<br />
            Der Regiebericht wurde wahrscheinlich bereits unterschrieben oder er existiert nicht.
        </p>
    </div>
</div>
