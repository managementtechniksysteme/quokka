    ...
    <div class="q-container">
        ...
        <div class="q-page-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="q-eyebrow">Adresse bearbeiten</div>
                    <h1 class="q-title">{{ $address->address_line }}</h1>
                </div>
            </div>
        </div>

        <form class="q-form needs-validation" action="{{ route('addresses.update', $address) }}" method="post" novalidate>
            @method('PATCH')
