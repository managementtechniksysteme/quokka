                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end w-100">
                            <form action="{{ route('addresses.index') }}" method="get">
                                ...
                                <button type="submit" name="sort" value="street-number-asc" class="dropdown-item w-100  d-inline-flex align-items-center">
                                    <svg class="icon icon-16 me-2">
                                        <use xlink:href="{{ asset('svg/feather-sprite.svg') }}#arrow-up"></use>
                                    </svg>
                                    Straße Nr
                                </button>
                                <button type="submit" name="sort" value="street-number-desc" class="dropdown-item w-100  d-inline-flex align-items-center">
                                    <svg class="icon icon-16 me-2">
                                        <use xlink:href="{{ asset('svg/feather-sprite.svg') }}#arrow-down"></use>
                                    </svg>
                                    Straße Nr
                                </button>
                                <button type="submit" name="sort" value="postcode-asc" class="dropdown-item w-100  d-inline-flex align-items-center">
                                    <svg class="icon icon-16 me-2">
                                        <use xlink:href="{{ asset('svg/feather-sprite.svg') }}#arrow-up"></use>
                                    </svg>
                                    Postleitzahl
                                </button>
                                <button type="submit" name="sort" value="postcode-desc" class="dropdown-item w-100  d-inline-flex align-items-center">
                                    <svg class="icon icon-16 me-2">
                                        <use xlink:href="{{ asset('svg/feather-sprite.svg') }}#arrow-down"></use>
                                    </svg>
                                    Postleitzahl
