            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <div class="btn-group @error('prune_read_notifications') is-invalid @enderror" >
                        ...
                        <label class="btn btn-outline-secondary" for="prune_read_notifications-0">nicht entfernen</label>
                    </div>
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <div class="btn-group @error('prune_sent_emails') is-invalid @enderror" >
                        ...
                        <label class="btn btn-outline-secondary" for="prune_sent_emails-0">nicht entfernen</label>
                    </div>
