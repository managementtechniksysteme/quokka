...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="form-group">
            ...
            <vue-easymde :configs="{spellChecker: false, status: false, showIcons: ['strikethrough', 'table', ], hideIcons: ['guide', ] }" name="comment" placeholder="Kommentar"  value="{{ old('comment', optional($comment)->comment) }}" v-cloak></vue-easymde>
...
<div class="row mt-4">
    <div class="col-md-4">
        ...
        <p class="text-muted">
            Dem Kommentar zugeordnete Anhänge. Erlaubt sind Dateien im Bildformat.
        </p>
        <p class="text-muted">
