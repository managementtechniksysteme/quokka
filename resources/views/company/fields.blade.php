...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="row g-3">
            ...
            <div class="mb-3 d-none d-lg-block col-lg-auto">
                <label>&nbsp;</label>
                <button class="btn btn-outline-secondary d-flex align-items-center" type="button" data-bs-toggle="collapse" data-bs-target="#newOperatorAddressFields">
                    <svg class="icon icon-16 me-2">
                        <use xlink:href="{{ asset('svg/feather-sprite.svg') }}#plus"></use>
                    </svg>
                    Neue Adresse anlegen
        ...
        <button class="btn btn-outline-secondary d-flex align-items-center d-lg-none mb-3" type="button" data-bs-toggle="collapse" data-bs-target="#newOperatorAddressFields">
            <svg class="icon icon-16 me-2">
                <use xlink:href="{{ asset('svg/feather-sprite.svg') }}#plus"></use>
            </svg>
            Neue Adresse anlegen
