...
@section('content')
    <div class="bg-gray-100 mt-0">
        <div class="container py-4">
            <h3>Bautagesbericht anlegen</h3>
        </div>
    </div>

    <div class="container my-4">
        <form class="needs-validation mt-4" enctype="multipart/form-data" action="{{ route('construction-reports.store') }}" method="post" novalidate>
