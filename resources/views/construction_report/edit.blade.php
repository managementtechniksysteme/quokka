...
@section('mobile-detail-bar')
    <a href="{{ route('construction-reports.show', $constructionReport) }}" class="q-appbar__btn" aria-label="Abbrechen">
    ...
    <div class="q-container">
        ...
        <form class="q-form needs-validation" enctype="multipart/form-data" action="{{ route('construction-reports.update', $constructionReport) }}" method="post" novalidate>
            ...
            <div class="q-form-actions q-form-actions--solo-mobile">
                <a class="btn q-btn d-none d-md-inline-flex align-items-center gap-2" href="{{ route('construction-reports.show', $constructionReport) }}"><svg class="icon-bs icon-16"><use href="{{ asset('svg/bootstrap-icons.svg') }}#x"></use></svg>Abbrechen</a>
