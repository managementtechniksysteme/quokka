...
@section('content')
    <div class="bg-gray-100 mt-0">
        <div class="container py-4">
            ...
            <h3>
                Bautagesbericht per Email senden
    ...
    <div class="container my-4">
        <form class="needs-validation mt-4" action="{{ route('construction-reports.email', ['construction_report' => $constructionReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="text-muted">
                        Hier können die gewünschten Email Adressen angegeben werden, an welche der Bautagesbericht per Email gesendet werden soll.
                    </p>
                </div>
                                ...
                                <div class="row my-2 align-items-center">
                                    ...
                                    <div class="col-auto ms-auto">
                                        <div class="form-check form-switch">
                                            <input type="checkbox" class="form-check-input @error('attachment_ids[]') is-invalid @enderror" name="attachment_ids[]" id="attachment_ids[{{ $attachment->id }}]" value="{{ $attachment->id }}" @if(empty(Request::old()) || (is_array(old('attachment_ids')) && in_array($attachment->id, old('attachment_ids')))) checked @endif>
                                            <label class="form-check-label" for="attachment_ids[{{ $attachment->id }}]">&nbsp;</label>
                                        </div>
