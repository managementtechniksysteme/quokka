...
@section('content')
    <div class="bg-gray-100 mt-0">
        <div class="container py-4">
            ...
            <h3>
                Bautagesbericht Anfrage zum Herunterladen senden
    ...
    <div class="container my-4">
        <form class="needs-validation mt-4" action="{{ route('construction-reports.email-download-request', ['construction_report' => $constructionReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
