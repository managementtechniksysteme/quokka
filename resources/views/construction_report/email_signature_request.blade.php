...
@section('content')
    <div class="bg-gray-100 mt-0">
        <div class="container py-4">
            ...
            <h3>
                Bautagesbericht Anfrage zur Unterschrift senden
    ...
    <div class="container my-4">
        <form class="needs-validation mt-4" action="{{ route('construction-reports.email-signature-request', ['construction_report' => $constructionReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="text-muted">
                        Die Email Addresse der Firma, welcher der Bautagesbericht zugeordnet ist, wird automatisch eingetragen.
                    </p>
                </div>
