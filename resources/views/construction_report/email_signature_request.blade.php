...
@section('content')
    <div class="q-container">
        ...
        <form class="q-form needs-validation mt-4" action="{{ route('construction-reports.email-signature-request', ['construction_report' => $constructionReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
