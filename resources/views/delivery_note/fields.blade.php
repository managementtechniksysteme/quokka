...
<div class="q-form-section">
    ...
    <div class="q-form-section__body">
        <markdown-editor name="comment" placeholder="Bemerkungen zum Lieferschein" value="{{ old('comment', optional($deliveryNote)->comment) }}" :employees="{{ $employees }}" v-cloak></markdown-editor>
