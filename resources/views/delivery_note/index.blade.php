                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end w-100">
                            <form action="{{ route('delivery-notes.index') }}" method="get">
                                ...
                                <button type="submit" name="sort" value="written_on-asc" class="dropdown-item w-100  d-inline-flex align-items-center">
                                    <svg class="icon icon-16 me-2">
                                        <use xlink:href="{{ asset('svg/feather-sprite.svg') }}#arrow-up"></use>
                                    </svg>
                                    Datum
                                </button>
                                <button type="submit" name="sort" value="written_on-desc" class="dropdown-item w-100  d-inline-flex align-items-center">
                                    <svg class="icon icon-16 me-2">
