...
@section('content')
    ...
    <div class="container my-4">
        <div class="text-center mt-4">
            ...
            <p class="lead text-muted mt-1">Vielen Dank, dass Sie den Lieferschein unterschrieben haben.</p>
        </div>

        <h4 class="mt-4">Lieferschein herunterladen</h4>

        <p>Klicken Sie auf folgenden Button, um den Lieferschein im PDF Format zur Archivierung herunterzuladen.</p>
        ...
        <p class="mt-4">Alternativ können Sie sich einen Link zum Herunterladen per Email schicken lassen, falls Sie den Lieferschein auf einem anderen Gerät herunterladen möchten. Geben Sie hierzu bitte die gewünschte Email Adresse in folgendes Feld ein und klicken anschließend auf den Button.</p>
