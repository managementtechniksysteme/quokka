...
<div class="q-form-section">
    ...
    <div class="q-form-section__body d-flex flex-column gap-3">
        ...
        <div>
            ...
            <markdown-editor name="comment" placeholder="Bemerkungen zur Finanzgruppe" value="{{ old('comment', optional($financeGroup)->comment) }}" :employees="{{ $employees }}" v-cloak></markdown-editor>
