        ...
        <div class="q-page-head d-none d-md-flex">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <h1 class="q-title">Prüfbericht (DM) senden</h1>
                </div>
            </div>
        </div>

        <form class="q-form needs-validation mt-2 mt-md-4" action="{{ route('flow-meter-inspection-reports.email', ['flow_meter_inspection_report' => $flowMeterInspectionReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
            ...
            <div class="q-form-actions q-form-actions--solo-mobile">
                ...
                <button type="submit" class="btn btn-primary text-white d-inline-flex align-items-center gap-2">
                    ...
                    <span class="d-none d-md-inline">Prüfbericht (DM) senden</span>
