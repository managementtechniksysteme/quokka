...
@section('content')
    <div class="q-container">
        ...
        <form class="q-form needs-validation mt-4" action="{{ route('flow-meter-inspection-reports.email-signature-request', ['flow_meter_inspection_report' => $flowMeterInspectionReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
