...
<div class="q-form-section">
    ...
    <div class="q-form-section__body">
        <markdown-editor name="comment" placeholder="Kommentare zur Prüfung" value="{{ old('comment', optional($flowMeterInspectionReport)->comment) }}" :employees="{{ $employees }}" v-cloak></markdown-editor>
