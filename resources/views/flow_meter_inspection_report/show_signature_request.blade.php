...
@section('mobile-detail-bar')
    <a href="{{ route('flow-meter-inspection-reports.show', $flowMeterInspectionReport) }}" class="q-appbar__btn" aria-label="Zurück">
        ...
        @if($flowMeterInspectionReport)
            ...
            <div class="q-card mt-2 mt-md-4">
                ...
                <div class="q-card__body">
                    ...
                    <form action="{{ route('flow-meter-inspection-reports.sign', ['flow_meter_inspection_report' => $flowMeterInspectionReport, 'redirect' => request()->redirect]) }}" method="post">
                        @csrf
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <button type="submit" class="btn btn-primary text-white d-inline-flex align-items-center gap-2">
                                ...
                                <span class="d-none d-md-inline">Prüfbericht unterschreiben</span>
