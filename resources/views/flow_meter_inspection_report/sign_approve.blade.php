...
@section('content')
    ...
    <div class="container my-4">
        ...
        <div class="text-center">
            <a class="btn btn-primary d-inline-flex align-items-center" href="{{ route('flow-meter-inspection-reports.customer-download', $flowMeterInspectionReport->downloadRequest->token) }}">
