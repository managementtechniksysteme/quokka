        ...
        <div class="d-flex flex-column gap-3">
            ...
            <div class="q-card">
                ...
                <div class="q-card__body">
                    ...
                    <a class="btn btn-primary text-white d-inline-flex align-items-center gap-2" href="{{ route('flow-meter-inspection-reports.customer-download', $flowMeterInspectionReport->downloadRequest->token) }}">
                    ...
                    <form class="needs-validation" action="{{ route('flow-meter-inspection-reports.customer-email-download-request', $flowMeterInspectionReport->downloadRequest->token) }}" method="post" novalidate>
                        @csrf

                        <div class="row g-2 align-items-center">
                            <div class="col-12 col-md-6">
                                <input type="email" class="form-control" name="email" placeholder="Email Adresse" value="{{ optional($flowMeterInspectionReport->project->company->contactPerson)->email ?? $flowMeterInspectionReport->project->company->email }}" required />
                            </div>
