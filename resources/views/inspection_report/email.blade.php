...
@section('content')
    ...
    <div class="container my-4">
        <form class="needs-validation mt-4" action="{{ route('inspection-reports.email', ['inspection_report' => $inspectionReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
