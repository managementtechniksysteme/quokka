    ...
    <div class="q-container">
        ...
        <div class="q-page-head d-none d-md-flex">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="q-eyebrow">Anlage {{ $inspectionReport->equipment_identifier }} &middot; {{ $inspectionReport->project->name }}</div>
                    <h1 class="q-title">Prüfbericht senden</h1>
                </div>
            </div>
        </div>

        <form class="q-form needs-validation mt-2 mt-md-4" action="{{ route('inspection-reports.email', ['inspection_report' => $inspectionReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
            ...
            <div class="q-form-actions q-form-actions--solo-mobile">
                ...
                <button type="submit" class="btn btn-primary text-white d-inline-flex align-items-center gap-2">
                    ...
                    <span class="d-none d-md-inline">Prüfbericht senden</span>
