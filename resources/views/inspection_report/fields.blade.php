...
<div class="q-form-section">
    ...
    <div class="q-form-section__body">
        <markdown-editor name="comment" placeholder="Durchgeführte Arbeiten und Bemerkungen" value="{{ old('comment', optional($inspectionReport)->comment) }}" :employees="{{ $employees }}" v-cloak></markdown-editor>
