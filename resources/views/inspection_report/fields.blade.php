...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="mb-3">
            ...
            @endif
            <div class="btn-group">
                <input type="radio" class="btn-check" name="status" id="new" @if(optional($inspectionReport)->status == 'new' || !$inspectionReport) checked @endif disabled>
                    <label class="btn btn-outline-secondary" for="new">neu</label>
                <input type="radio" class="btn-check" name="status" id="signed" @if(optional($inspectionReport)->status == 'signed') checked @endif disabled>
                    <label class="btn btn-outline-secondary" for="signed">unterschrieben</label>
                <input type="radio" class="btn-check" name="status" id="finished" @if(optional($inspectionReport)->status == 'finished') checked @endif disabled>
        ...
        <div class="mb-3">
            ...
            <div class="btn-group @error('weather') is-invalid @enderror">
                <input type="radio" class="btn-check" name="weather" id="sunny" value="sunny" autocomplete="off" @if(old('weather', optional($inspectionReport)->weather) == 'sunny') checked @endif>
                    <label class="btn btn-outline-secondary" for="sunny">sonnig</label>
                <input type="radio" class="btn-check" name="weather" id="cloudy" value="cloudy" autocomplete="off" @if(old('weather', optional($inspectionReport)->weather) == 'cloudy') checked @endif>
                    <label class="btn btn-outline-secondary" for="cloudy">bewölkt</label>
                <input type="radio" class="btn-check" name="weather" id="rainy" value="rainy" autocomplete="off" @if(old('weather', optional($inspectionReport)->weather) == 'rainy') checked @endif>
                    <label class="btn btn-outline-secondary" for="rainy">regnerisch</label>
                <input type="radio" class="btn-check" name="weather" id="snowy" value="snowy" autocomplete="off" @if(old('weather', optional($inspectionReport)->weather) == 'snowy') checked @endif>
    ...
    <div class="col-md-8">
        ...
        <div class="mb-3">
            ...
            <div class="btn-group @error('uvc_lamp_values_unit') is-invalid @enderror">
                <input type="radio" class="btn-check" name="uvc_lamp_values_unit" id="percent" value="percent" autocomplete="off" @if(old('uvc_lamp_values_unit', optional($inspectionReport)->uvc_lamp_values_unit) == 'percent') checked @endif>
                    <label class="btn btn-outline-secondary" for="percent">%</label>
                <input type="radio" class="btn-check" name="uvc_lamp_values_unit" id="W_m2" value="W_m2" autocomplete="off" @if(old('uvc_lamp_values_unit', optional($inspectionReport)->uvc_lamp_values_unit) == 'W_m2') checked @endif>
                    <label class="btn btn-outline-secondary" for="W_m2">W/m²</label>
            </div>
        ...
        <div class="mb-3">
            ...
            <div class="btn-group @error('uvc_lamp_replacement_available') is-invalid @enderror">
                <input type="radio" class="btn-check" name="uvc_lamp_replacement_available" id=1 value=1 autocomplete="off" @if(old('uvc_lamp_replacement_available') === '1' || ($inspectionReport && $inspectionReport->uvc_lamp_replacement_available === true)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">ja</label>
                <input type="radio" class="btn-check" name="uvc_lamp_replacement_available" id=0 value=0 autocomplete="off" @if(old('uvc_lamp_replacement_available') === '0' || ($inspectionReport && $inspectionReport->uvc_lamp_replacement_available === false)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">nein</label>
                <input type="radio" class="btn-check" name="uvc_lamp_replacement_available" id="" value="" autocomplete="off" @if((old('_token') && old('uvc_lamp_replacement_available') === null) || ($inspectionReport && $inspectionReport->uvc_lamp_replacement_available === null)) checked @endif>
    ...
    <div class="col-md-8">
        ...
        <div class="mb-3">
            ...
            <div class="btn-group @error('uvc_sensor_values_unit') is-invalid @enderror">
                <input type="radio" class="btn-check" name="uvc_sensor_values_unit" id="percent" value="percent" autocomplete="off" @if(old('uvc_sensor_values_unit', optional($inspectionReport)->uvc_sensor_values_unit) == 'percent') checked @endif>
                    <label class="btn btn-outline-secondary" for="percent">%</label>
                <input type="radio" class="btn-check" name="uvc_sensor_values_unit" id="W_m2" value="W_m2" autocomplete="off" @if(old('uvc_sensor_values_unit', optional($inspectionReport)->uvc_sensor_values_unit) == 'W_m2') checked @endif>
                    <label class="btn btn-outline-secondary" for="W_m2">W/m²</label>
            </div>
    ...
    <div class="col-md-8">
        <div class="mb-3">
            ...
            <div class="btn-group @error('quartz_tube_contaminated') is-invalid @enderror">
                <input type="radio" class="btn-check" name="quartz_tube_contaminated" id=1 value=1 autocomplete="off" @if(old('quartz_tube_contaminated') === '1' || ($inspectionReport && $inspectionReport->quartz_tube_contaminated === true)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">ja</label>
                <input type="radio" class="btn-check" name="quartz_tube_contaminated" id=0 value=0 autocomplete="off" @if(old('quartz_tube_contaminated') === '0' || ($inspectionReport && $inspectionReport->quartz_tube_contaminated === false)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">nein</label>
                <input type="radio" class="btn-check" name="quartz_tube_contaminated" id="" value="" autocomplete="off" @if((old('_token') && old('quartz_tube_contaminated') === null) || ($inspectionReport && $inspectionReport->quartz_tube_contaminated === null)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">keine Angabe</label>
            </div>
        ...
        <div class="mb-3">
            ...
            <div class="btn-group @error('quartz_tube_leaking') is-invalid @enderror">
                <input type="radio" class="btn-check" name="quartz_tube_leaking" id=1 value=1 autocomplete="off" @if(old('quartz_tube_leaking') === '1' || ($inspectionReport && $inspectionReport->quartz_tube_leaking === true)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">ja</label>
                <input type="radio" class="btn-check" name="quartz_tube_leaking" id=0 value=0 autocomplete="off" @if(old('quartz_tube_leaking') === '0' || ($inspectionReport && $inspectionReport->quartz_tube_leaking === false)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">nein</label>
                <input type="radio" class="btn-check" name="quartz_tube_leaking" id="" value="" autocomplete="off" @if((old('_token') && old('quartz_tube_leaking') === null) || ($inspectionReport && $inspectionReport->quartz_tube_leaking === null)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">keine Angabe</label>
            </div>
    ...
    <div class="col-md-8">
        ...
        <div class="mb-3">
            ...
            <div class="btn-group @error('water_suspended_load_visible') is-invalid @enderror">
                <input type="radio" class="btn-check" name="water_suspended_load_visible" id=1 value=1 autocomplete="off" @if(old('water_suspended_load_visible') === '1' || ($inspectionReport && $inspectionReport->water_suspended_load_visible === true)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">ja</label>
                <input type="radio" class="btn-check" name="water_suspended_load_visible" id=0 value=0 autocomplete="off" @if(old('water_suspended_load_visible') === '0' || ($inspectionReport && $inspectionReport->water_suspended_load_visible === false)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">nein</label>
                <input type="radio" class="btn-check" name="water_suspended_load_visible" id="" value="" autocomplete="off" @if((old('_token') && old('water_suspended_load_visible') === null) || ($inspectionReport && $inspectionReport->water_suspended_load_visible === null)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">keine Angabe</label>
            </div>
        ...
        <div class="mb-3">
            ...
            <div class="btn-group @error('water_air_bubble_free') is-invalid @enderror">
                <input type="radio" class="btn-check" name="water_air_bubble_free" id=1 value=1 autocomplete="off" @if(old('water_air_bubble_free') === '1' || ($inspectionReport && $inspectionReport->water_air_bubble_free === true)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">ja</label>
                <input type="radio" class="btn-check" name="water_air_bubble_free" id=0 value=0 autocomplete="off" @if(old('water_air_bubble_free') === '0' || ($inspectionReport && $inspectionReport->water_air_bubble_free === false)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">nein</label>
                <input type="radio" class="btn-check" name="water_air_bubble_free" id="" value="" autocomplete="off" @if((old('_token') && old('water_air_bubble_free') === null) || ($inspectionReport && $inspectionReport->water_air_bubble_free === null)) checked @endif>
                    <label class="btn btn-outline-secondary" for="">keine Angabe</label>
            </div>
