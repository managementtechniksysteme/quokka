...
\hline
@endforeach
\footnotesize{} & \footnotesize{\textbf{Summe}} & \footnotesize{@if(array_sum(array_column($group, 'amount'))>=0) \footnotesize{{!! Latex::escape(Number::toLocal(array_sum(array_column($group, 'amount'))) . $currencyUnit) !!}} @else \footnotesize{\textcolor{red}{{!! Latex::escape(Number::toLocal(array_sum(array_column($group['amount']))) . $currencyUnit) !!}}} @endif} \\
\hline
\end{longtable}
@endforeach
\end{document}
