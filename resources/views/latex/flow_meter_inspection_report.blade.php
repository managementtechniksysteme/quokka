...
\end{figure}
\vspace*{1cm}
\huge{\textbf{Prüfbericht}} \\
\vspace*{0.5cm}
\huge{\textbf{Durchflussmesseinrichtungen in geschlossenen Profilen}}
\vfill
...
\footnotesize{\textbf{Art der Wasserstandsmessung \newline (bei teilgefüllten Messstrecken):}} & \footnotesize{{!! Latex::escape($flowMeterInspectionReport->water_level_measurement_type ?? '') !!}} \\
\end{tabular}
...
\footnotesize{\textbf{Ist eine Dokumentation über Messstelle, \newline Mess- und Auswertegeräte vorhanden?}} & \footnotesize{{!! Latex::escape($flowMeterInspectionReport->documentation_existent_string) !!}} \\
...
\footnotesize{\textbf{Stimmen die Einbaubedingungen mit der \newline Dokumentation überein?}} & \footnotesize{{!! Latex::escape($flowMeterInspectionReport->documentation_current_string) !!}} \\
...
\footnotesize{\textbf{Messbereich des Messrohrs laut \newline Herstellerangabe 100\%:}} & \footnotesize{{!! Latex::escape($flowMeterInspectionReport->measuring_pipe_maximum_flow_rate ? $flowMeterInspectionReport->measuring_pipe_maximum_flow_rate . '' . $flowMeterInspectionReport->measuring_pipe_maximum_flow_rate_unit_string . ' bei ' . $flowMeterInspectionReport->measuring_pipe_maximum_speed . '' . $flowMeterInspectionReport->measuring_pipe_maximum_speed_unit_string : '') !!}} \\
\footnotesize{\textbf{Einstellung der Schleimmengenunterdrückung:}} & \footnotesize{{!! Latex::escape($flowMeterInspectionReport->mucus_suppression ?? '') !!}{!! Latex::escape($flowMeterInspectionReport->mucus_suppression ? trans($flowMeterInspectionReport->mucus_suppression_unit) : '') !!}} \\
\footnotesize{\textbf{Tatsächlicher im Betrieb beobachteter \newline Durchflussbereich (laut Betriebsprotokollen):}} & \footnotesize{Q\textsubscript{min}(5\% Wert): {!! Latex::escape($flowMeterInspectionReport->q_min ?? '') !!}{!! Latex::escape('l/s') !!}, Q\textsubscript{max}(95\% Wert): {!! Latex::escape($flowMeterInspectionReport->q_max ?? '') !!}{!! Latex::escape('l/s') !!}} \\
...
\footnotesize{\textbf{Signalausgang:}} & \footnotesize{von {!! Latex::escape($flowMeterInspectionReport->measurement_transformer_level_unit === 'interface' ? trans($flowMeterInspectionReport->measurement_transformer_level_unit) : $flowMeterInspectionReport->measurement_transformer_minimum_level . ' bis ' . $flowMeterInspectionReport->measurement_transformer_maximum_level . '' . $flowMeterInspectionReport->measurement_transformer_level_unit_string) !!}} \\
...
\footnotesize{\textbf{Die Aufzeichnung der Durchflusssummen und \newline Momentanwerte, die für die Betriebsprotokolle \newline verwendet wird, erfolgt durch:}} & \footnotesize{{!! Latex::escape($flowMeterInspectionReport->measurement_transformer_data_logging) !!}} \\
\end{tabular}
...
\footnotesize{\textbf{Ist im Messrohr bei den Durchflüssen \newline der Vergleichsmessung die geforderte Fließtiefe \newline (Füllhöhe) vorhanden?}} & \footnotesize{{!! Latex::escape($flowMeterInspectionReport->measurement_section_pipe_required_fill_level_existent_string) !!}} \\
...
\footnotesize{\textbf{Sind Ablagerungen, Verschmutzungen im \newline Messrohr/am Messwertaufnehmer ersichtlich?}} & \footnotesize{{!! Latex::escape($flowMeterInspectionReport->measurement_section_pipe_contaminated_string) !!}} \\
...
\footnotesize{\textbf{Bei Teilfüllung: Werden die Strömungsverhältnisse im Unterwasser vom Vorfluter oder anderen \newline Einleitungen beeinflusst?}} & \footnotesize{{!! Latex::escape($flowMeterInspectionReport->tailwater_flow_conditions_influenced ? 'ja, durch '.$flowMeterInspectionReport->tailwater_flow_conditions_influencer : 'nein') !!}} \\
\end{tabular}
...
\begin{tabular}{|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|}
\hline
\multicolumn{1}{|c|}{\tiny{(1)}} & \multicolumn{1}{c|}{\tiny{(2)}} & \multicolumn{1}{c|}{\tiny{(3)}} & \multicolumn{1}{c|}{\tiny{(4)}} & \multicolumn{1}{c|}{\tiny{(5)}} & \multicolumn{1}{c|}{\tiny{(6)}} & \multicolumn{1}{c|}{\tiny{(7)}} & \multicolumn{1}{c|}{\tiny{(8)}} & \multicolumn{1}{c|}{\tiny{(9)}} & \multicolumn{1}{c|}{\tiny{(10)}} & \multicolumn{1}{c|}{\tiny{(11)}} &  \multicolumn{1}{c|}{\tiny{(12)}} & \multicolumn{1}{c|}{\tiny{(13)}} & \multicolumn{1}{c|}{\tiny{(14)}} & \multicolumn{1}{c|}{\tiny{(15)}} & \multicolumn{1}{c|}{\tiny{(16)}} \\
\hline
\multicolumn{2}{|c|}{\tiny{\shortstack{Messbereich des \\ stationären Systems}}} & \multicolumn{1}{c|}{\tiny{Uhrzeit}} & \multicolumn{1}{c|}{\tiny{Dauer\textsuperscript{**}}} & \multicolumn{1}{c|}{\tiny{Uhrzeit}} & \multicolumn{3}{c|}{\tiny{Messwertumformer}} & \multicolumn{3}{c|}{\tiny{Prozessleitsystem}} & \multicolumn{3}{c|}{\tiny{Vergleichsmessung}} & \multicolumn{1}{c|}{\tiny{\shortstack{Abweichung\\Vergleich/\\stationär}}} & \multicolumn{1}{c|}{\tiny{\shortstack{errechneter\\Mittelwert\\mobil}}} \\
\hline
\multicolumn{1}{|c|}{\tiny{\% Q}} & \multicolumn{1}{c|}{\tiny{l/s}} & \multicolumn{1}{c|}{\tiny{Start}} & \multicolumn{1}{c|}{\tiny{Minuten}} & \multicolumn{1}{c|}{\tiny{Ende}} & \multicolumn{2}{c|}{\tiny{Zählerstand m\textsuperscript{3}}} & \multicolumn{1}{c|}{\tiny{Summe}} & \multicolumn{2}{c|}{\tiny{Zählerstand m\textsuperscript{3}}} & \multicolumn{1}{c|}{\tiny{Summe}} &  \multicolumn{2}{c|}{\tiny{m\textsuperscript{3}}} & \multicolumn{1}{c|}{\tiny{Summe}} & \multicolumn{1}{c|}{\tiny{\%}} & \multicolumn{1}{c|}{\tiny{l/s}} \\
\hline
\multicolumn{1}{|c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{= (5)-(3)}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{Start}} & \multicolumn{1}{c|}{\tiny{Ende}} & \multicolumn{1}{c|}{\tiny{= (7)-(6)}} & \multicolumn{1}{c|}{\tiny{Start}} & \multicolumn{1}{c|}{\tiny{Ende}} & \multicolumn{1}{c|}{\tiny{= (10)-(9)}} &  \multicolumn{1}{c|}{\tiny{Start}} & \multicolumn{1}{c|}{\tiny{Ende}} & \multicolumn{1}{c|}{\tiny{= (13)-(12)}} & \multicolumn{1}{c|}{\tiny{= [(11)-(14)]/(14)}} & \multicolumn{1}{c|}{\tiny{vgl. (2)}} \\
\hline
\multicolumn{1}{|c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ100)->started_at)->format('d.m.y') ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ100)->ended_at)->format("d.m.y") ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{}} &  \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{}} & \multicolumn{1}{c|}{\tiny{()}} \\
\hline
\multicolumn{1}{|c|}{\tiny{Gesamt}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->q_value ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ100)->started_at)->format("H:i") ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape($flowMeterInspectionReport->measurementsQ100 && $flowMeterInspectionReport->measurementsQ100->started_at && $flowMeterInspectionReport->measurementsQ100->ended_at ? $flowMeterInspectionReport->measurementsQ100->started_at->diffInHours($flowMeterInspectionReport->measurementsQ100->ended_at) . ':' . $flowMeterInspectionReport->measurementsQ100->started_at->diff($flowMeterInspectionReport->measurementsQ100->ended_at)->format("%I") : '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ100)->ended_at)->format("H:i") ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->measurement_transformer_reading_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->measurement_transformer_reading_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->measurement_transformer_reading_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->pcs_reading_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->pcs_reading_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->pcs_reading_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->comparison_measurement_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->comparison_measurement_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->comparison_measurement_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->measurement_difference ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ100)->q_value_average_mobile ?? '') !!}}} \\
\hline
\multicolumn{1}{|c|}{\tiny{(51-) 70\%\textsuperscript{*} =}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->q_value ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ70)->started_at)->format("H:i") ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape($flowMeterInspectionReport->measurementsQ70 && $flowMeterInspectionReport->measurementsQ70->started_at && $flowMeterInspectionReport->measurementsQ70->ended_at ? $flowMeterInspectionReport->measurementsQ70->ended_at->diff($flowMeterInspectionReport->measurementsQ70->started_at)->format("%H:%I") : '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ70)->ended_at)->format("H:i") ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->measurement_transformer_reading_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->measurement_transformer_reading_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->measurement_transformer_reading_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->pcs_reading_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->pcs_reading_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->pcs_reading_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->comparison_measurement_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->comparison_measurement_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->comparison_measurement_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->measurement_difference ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ70)->q_value_average_mobile ?? '') !!}}} \\
\hline
\multicolumn{1}{|c|}{\tiny{(31-) 50\% =}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->q_value ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ50)->started_at)->format("H:i") ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape($flowMeterInspectionReport->measurementsQ50 && $flowMeterInspectionReport->measurementsQ50->started_at && $flowMeterInspectionReport->measurementsQ50->ended_at ? $flowMeterInspectionReport->measurementsQ50->ended_at->diff($flowMeterInspectionReport->measurementsQ50->started_at)->format("%H:%I") : '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ50)->ended_at)->format("H:i") ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->measurement_transformer_reading_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->measurement_transformer_reading_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->measurement_transformer_reading_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->pcs_reading_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->pcs_reading_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->pcs_reading_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->comparison_measurement_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->comparison_measurement_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->comparison_measurement_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->measurement_difference ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ50)->q_value_average_mobile ?? '') !!}}} \\
\hline
\multicolumn{1}{|c|}{\tiny{(21-) 30\% =}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->q_value ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ30)->started_at)->format("H:i") ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape($flowMeterInspectionReport->measurementsQ30 && $flowMeterInspectionReport->measurementsQ30->started_at && $flowMeterInspectionReport->measurementsQ30->ended_at ? $flowMeterInspectionReport->measurementsQ30->ended_at->diff($flowMeterInspectionReport->measurementsQ30->started_at)->format("%H:%I") : '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ30)->ended_at)->format("H:i") ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->measurement_transformer_reading_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->measurement_transformer_reading_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->measurement_transformer_reading_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->pcs_reading_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->pcs_reading_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->pcs_reading_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->comparison_measurement_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->comparison_measurement_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->comparison_measurement_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->measurement_difference ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ30)->q_value_average_mobile ?? '') !!}}} \\
\hline
\multicolumn{1}{|c|}{\tiny{(10-) 20\% =}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->q_value ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ20)->started_at)->format("H:i") ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape($flowMeterInspectionReport->measurementsQ20 && $flowMeterInspectionReport->measurementsQ20->started_at && $flowMeterInspectionReport->measurementsQ20->ended_at ? $flowMeterInspectionReport->measurementsQ20->ended_at->diff($flowMeterInspectionReport->measurementsQ20->started_at)->format("%H:%I") : '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional(optional($flowMeterInspectionReport->measurementsQ20)->ended_at)->format("H:i") ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->measurement_transformer_reading_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->measurement_transformer_reading_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->measurement_transformer_reading_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->pcs_reading_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->pcs_reading_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->pcs_reading_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->comparison_measurement_start ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->comparison_measurement_end ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->comparison_measurement_sum ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->measurement_difference ?? '') !!}}} & \multicolumn{1}{c|}{\tiny{{!! Latex::escape(optional($flowMeterInspectionReport->measurementsQ20)->q_value_average_mobile ?? '') !!}}} \\
\hline
\end{tabular}
...
\item Die Vergleichsmessung soll dann zumindest in den unteren 3 Bereichen (10-50\% vom Messbereichsendwert) durchgeführt werden. Dies wird in den Spalten (3) bis (5) dokumentiert.
...
\item Abschließend wird in Spalte (15) die Abweichung zwischen der Vergleichsmessung und der stationären Messung (Spalte (11) dividiert durch (14)) berechnet und der Mittelwert des Durchflusses über die Dauer der Vergleichsmessung in den jeweiligen Bereichen berechnet.
