...
\footnotesize{\textbf{\textcolor{success}{erledigt am:}}} & \multicolumn{3}{l}{\footnotesize{\textcolor{success}{{!! Latex::escape($inspectionReport->updated_at)!!}@if($inspectionReport->activities->last()) ({!! Latex::escape(Str::upper($inspectionReport->activities->last()->causer->username)) !!})@endif}}} \\
@endif
\end{tabular}
...
\footnotesize{Anzahl, Typ:} & \footnotesize{{!! Latex::escape(Number::format($inspectionReport->uvc_lamp_quantity)) !!} x {!! Latex::escape($inspectionReport->uvc_lamp_type) !!}} & \footnotesize{Typ:} & \footnotesize{{!! Latex::escape($inspectionReport->uvc_sensor_type) !!}} \\
\footnotesize{Betriebsstunden:} & \footnotesize{{!! Latex::escape(Number::format($inspectionReport->uvc_lamp_operating_hours)) !!}{!! Latex::escape('h') !!}} & \footnotesize{Seriennummer:} & \footnotesize{{!! Latex::escape($inspectionReport->uvc_sensor_identifier) !!}} \\
\footnotesize{Impulse:} & \footnotesize{{!! Latex::escape(Number::format($inspectionReport->uvc_lamp_impulses)) !!}} & \footnotesize{Voralarm:} & \footnotesize{{!! Latex::escape(Number::format($inspectionReport->uvc_sensor_pre_alarm)) !!}{!! Latex::escape($inspectionReport->uvc_sensor_values_unit_string) !!}} \\
\footnotesize{UV Intensität bei Ankunft:} & \footnotesize{{!! Latex::escape(Number::format($inspectionReport->uvc_lamp_uv_intensity_arrival)) !!}{!! Latex::escape($inspectionReport->uvc_lamp_values_unit_string) !!}} & \footnotesize{Abschaltpunkt:} & \footnotesize{{!! Latex::escape(Number::format($inspectionReport->uvc_sensor_cut_off_point)) !!}{!! Latex::escape($inspectionReport->uvc_sensor_values_unit_string) !!}} \\
\footnotesize{UV Intensität bei Abfahrt:} & \footnotesize{{!! Latex::escape(Number::format($inspectionReport->uvc_lamp_uv_intensity_departure)) !!}{!! Latex::escape($inspectionReport->uvc_lamp_values_unit_string) !!}} & &  \\
...
\footnotesize{Durchfluss:} & \footnotesize{{!! Latex::escape(Number::format($inspectionReport->water_flow_rate)) !!} {!! Latex::escape('m³/h') !!}} & \footnotesize{Verschmutzung:} & \footnotesize{{!! Latex::escape($inspectionReport->quartz_tube_contaminated_string) !!}} \\
\footnotesize{min. Transmission[100mm]:} & \footnotesize{{!! Latex::escape(Number::format($inspectionReport->water_minimum_uv_transmission)) !!}{!! Latex::escape('%') !!}} & \footnotesize{Undicht:} & \footnotesize{{!! Latex::escape($inspectionReport->quartz_tube_leaking_string) !!}} \\
\footnotesize{gem. Transmission[100mm]:} & \footnotesize{{!! Latex::escape(Number::format($inspectionReport->water_measured_uv_transmission)) !!}{!! Latex::escape('%') !!}} & & \\
