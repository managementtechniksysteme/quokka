...
\footnotesize{UV Intensität bei Ankunft:} & \footnotesize{{!! Latex::escape(Number::toLocal($inspectionReport->uvc_lamp_uv_intensity_arrival)) !!}{!! Latex::escape($inspectionReport->uvc_lamp_values_unit_string) !!}} & \footnotesize{Abschaltpunkt:} & \footnotesize{{!! Latex::escape(Number::toLocal($inspectionReport->uvc_sensor_cut_off_point)) !!}{!! Latex::escape($inspectionReport->uvc_sensor_values_unit_string) !!}} \\
\footnotesize{UV Intensität bei Abfahrt:} & \footnotesize{{!! Latex::escape(Number::toLocal($inspectionReport->uvc_lamp_uv_intensity_departure)) !!}{!! Latex::escape($inspectionReport->uvc_lamp_values_unit_string) !!}} & &  \\
...
\footnotesize{min. Transmission[100mm]:} & \footnotesize{{!! Latex::escape(Number::toLocal($inspectionReport->water_minimum_uv_transmission)) !!}{!! Latex::escape('%') !!}} & \footnotesize{Undicht:} & \footnotesize{{!! Latex::escape($inspectionReport->quartz_tube_leaking_string) !!}} \\
\footnotesize{gem. Transmission[100mm]:} & \footnotesize{{!! Latex::escape(Number::toLocal($inspectionReport->water_measured_uv_transmission)) !!}{!! Latex::escape('%') !!}} & & \\
