...
\fancyfoot[L]{\footnotesize{Notiz von {!! Latex::escape(Str::upper($note->employee->user->username)) !!} am {!! Latex::escape($note->created_at->format('d.m.Y, H:i')) !!}, erstellt am {!! Latex::escape(\Carbon\Carbon::today()) !!}}}
