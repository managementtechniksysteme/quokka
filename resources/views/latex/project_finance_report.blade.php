...
\hline
\endhead
\footnotesize{Aktuell offene Projekte} & \footnotesize{{!! Latex::escape(Number::format($report['currentlyOpenProjectsData']['total_volume']) . $currencyUnit) !!}} & \footnotesize{{!! Latex::escape(Number::format($report['currentlyOpenProjectsData']['billed_volume']) . $currencyUnit) !!}} & \footnotesize{@if($report['currentlyOpenProjectsData']['total_volume']+$report['currentlyOpenProjectsData']['billed_volume']>0) \footnotesize{{!! Latex::escape(Number::format($report['currentlyOpenProjectsData']['total_volume']+$report['currentlyOpenProjectsData']['billed_volume']) . $currencyUnit) !!}} @else \footnotesize{\textcolor{red}{{!! Latex::escape(Number::format($report['currentlyOpenProjectsData']['total_volume']+$report['currentlyOpenProjectsData']['billed_volume']) . $currencyUnit) !!}}} @endif} \\
\hline
\footnotesize{Projekte in der Vorphase} & \footnotesize{{!! Latex::escape(Number::format($report['preExecutionProjectsData']['total_volume']) . $currencyUnit) !!}} & \footnotesize{{!! Latex::escape(Number::format($report['preExecutionProjectsData']['billed_volume']) . $currencyUnit) !!}} & \footnotesize{@if($report['preExecutionProjectsData']['total_volume']+$report['preExecutionProjectsData']['billed_volume']>0) \footnotesize{{!! Latex::escape(Number::format($report['preExecutionProjectsData']['total_volume']+$report['preExecutionProjectsData']['billed_volume']) . $currencyUnit) !!}} @else \footnotesize{\textcolor{red}{{!! Latex::escape(Number::format($report['preExecutionProjectsData']['total_volume']+$report['preExecutionProjectsData']['billed_volume']) . $currencyUnit) !!}}} @endif}  \\
\hline
\end{longtable}
...
\footnotesize{{!! Latex::escape($title) !!}} & \footnotesize{{!! Latex::escape(Number::format($projectRow['total_volume']) . $currencyUnit) !!}} & \footnotesize{{!! Latex::escape(Number::format($projectRow['billed_volume']) . $currencyUnit) !!}} & \footnotesize{@if($projectRow['total_volume']+$projectRow['billed_volume']>0) \footnotesize{{!! Latex::escape(Number::format($projectRow['total_volume']+$projectRow['billed_volume']) . $currencyUnit) !!}} @else \footnotesize{\textcolor{red}{{!! Latex::escape(Number::format($projectRow['total_volume']+$projectRow['billed_volume']) . $currencyUnit) !!}}} @endif} \\
\hline
@endforeach
\end{longtable}
\end{document}
