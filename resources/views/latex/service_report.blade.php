...
@endif
\footnotesize{\textbf{Techniker MTS:}} & \footnotesize{{!! Latex::escape($serviceReport->employee->person->name) !!}} & @if($serviceReport->status === 'finished')\footnotesize{\textbf{erledigt am:}}@endif & @if($serviceReport->status === 'finished')\footnotesize{{!! Latex::escape($serviceReport->updated_at)!!}}@endif \\
\end{tabular}
\section{Kurzbericht}
