...
<div class="row mt-4">
    ...
    <div class="col-md-8">
        <div class="form-group">
            ...
            <vue-easymde :configs="{maxHeight: '300px', spellChecker: false, status: false, showIcons: ['strikethrough', 'table', ], hideIcons: ['guide', ] }" name="comment" placeholder="Bemerkungen zum Aktenvermerk"  value="{{ old('comment', optional($memo)->comment) }}" v-cloak></vue-easymde>
