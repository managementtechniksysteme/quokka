...
@section('content')
    ...
    <div class="container my-4">
        <form class="needs-validation mt-4" action="{{ route('notes.email', ['note' => $note, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="text-muted">
                        Hier können die gewünschten Email Adressen angegeben werden, an welche die Notiz per Email gesendet werden soll.
                    </p>
                </div>
