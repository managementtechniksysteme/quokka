...
{{-- Mobile app bar: "X" close + generic title, same pattern as
     company/create.blade.php (2026-07-21). --}}
@section('mobile-detail-bar')
    <a href="{{ route('projects.index') }}" class="q-appbar__btn" aria-label="Abbrechen">
        <svg class="icon-bs icon-20"><use href="{{ asset('svg/bootstrap-icons.svg') }}#x-lg"></use></svg>
    </a>
    <span class="q-appbar__title">Projekt anlegen</span>
@endsection
    ...
    <div class="q-container">
        ...
        <form class="q-form needs-validation" action="{{ route('projects.store') }}" method="post" novalidate>
            ...
            <div class="q-form-actions q-form-actions--solo-mobile">
                <a class="btn q-btn d-none d-md-inline-flex align-items-center gap-2" href="{{ route('projects.index') }}"><svg class="icon-bs icon-16"><use href="{{ asset('svg/bootstrap-icons.svg') }}#x"></use></svg>Abbrechen</a>
