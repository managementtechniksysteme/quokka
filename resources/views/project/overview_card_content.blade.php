    ...
    <div class="mw-100 d-flex p-3 align-items-center">
        ...
        <div class="mw-100 d-flex flex-grow-1 h-100 align-items-center">
                    ...
                    @if(Auth::user()->can('projects.view.estimates') && Auth::user()->settings->show_cost_estimates)
                        @if($project->current_wage_costs_status || $project->current_material_costs_status || $project->current_costs_status || $project->current_billed_costs_status)
                            <span class="d-none d-md-inline-flex align-items-center">
                                <svg class="icon icon-12 ms-2 text-muted">
                                    <use xlink:href="{{ asset('svg/feather-sprite.svg') }}#dollar-sign"></use>
                                </svg>
                                @if($project->current_costs_status)
                                    <span class="text-muted ms-1">G</span>
                                ...
                                @if($project->current_wage_costs_status)
                                    <span class="text-muted ms-1">L</span>
            ...
            <div class="d-none d-sm-block ms-2">
                ...
                <a class="text-muted d-inline-flex align-items-center ms-2" href="{{ route('projects.show', [$project, 'tab' => 'memos']) }}">
                    <svg class="icon icon-16 me-1">
                ...
                <a class="text-muted d-inline-flex align-items-center ms-2" href="{{ route('projects.show', [$project, 'tab' => 'service_reports']) }}">
                    <svg class="icon icon-16 me-1">
            ...
            <div class="d-none d-md-block ms-2">
                <div class="dropdown d-inline">
                    <button class="btn btn-lg btn-link dropdown-toggle-vertical-points text-muted" type="button" id="projectOverviewDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>

                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="projectOverviewDropdown">
                        @can('update', $project)
