...
@section('content')
    <div class="q-container">
        ...
        <form class="q-form needs-validation mt-4" action="{{ route('service-reports.email', ['service_report' => $serviceReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
