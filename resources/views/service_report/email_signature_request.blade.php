...
@section('content')
    <div class="bg-gray-100 mt-0">
        <div class="container py-4">
            ...
            <h3>
                Servicebericht Anfrage zur Unterschrift senden
    ...
    <div class="container my-4">
        <form class="needs-validation mt-4" action="{{ route('service-reports.email-signature-request', ['service_report' => $serviceReport, 'redirect' => request()->redirect]) }}" method="post" novalidate>
            @csrf
