...
<div class="q-form-section">
    ...
    <div class="q-form-section__body">
        <markdown-editor name="comment" placeholder="Bemerkungen zum Servicebericht" value="{{ old('comment', optional($serviceReport)->comment) }}" :employees="{{ $employees }}" v-cloak></markdown-editor>
