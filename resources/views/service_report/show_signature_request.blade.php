...
@section('mobile-detail-bar')
    <a href="{{ route('service-reports.show', $serviceReport) }}" class="q-appbar__btn" aria-label="Zurück">
        <svg class="icon-bs icon-20"><use href="{{ asset('svg/bootstrap-icons.svg') }}#chevron-left"></use></svg>
    </a>
    <span class="q-appbar__title">Servicebericht #{{ $serviceReport->number }}</span>
@endsection
