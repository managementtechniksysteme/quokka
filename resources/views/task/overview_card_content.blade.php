    ...
    <div class="mw-100 d-flex flex-grow-1 p-3 align-items-center">
                    ...
                    @if(isset($secondaryInformation))
                        @switch($secondaryInformation)
                            @case('withoutProject')
                                ...
                                <div class="@if($task->isOverdue()) bg-red-100 text-red-800 rounded px-1 @elseif($task->isDueSoon()) bg-yellow-100 text-yellow-800 rounded px-1 @else text-muted @endif ms-2 d-inline-flex align-items-center">
                                    <svg class="icon icon-16 me-1">
                            ...
                            @default
                                ...
                                <div class="d-flex d-md-inline-flex align-items-center">
                                    <svg class="icon icon-16 ms-md-2 me-1">
                                        <use xlink:href="{{ asset('svg/feather-sprite.svg') }}#user"></use>
                                    </svg>
        ...
        <div class="d-none d-md-block ms-2">
            <div class="dropdown d-inline">
                <button class="btn btn-lg btn-link dropdown-toggle-vertical-points text-muted" type="button" id="taskOverviewDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>

                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="taskOverviewDropdown">
