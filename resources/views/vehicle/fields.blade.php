...
<div class="q-form-section">
    ...
    <div class="q-form-section__body">
        <markdown-editor name="comment" placeholder="Bemerkungen zum Fahrzeug" value="{{ old('comment', optional($vehicle)->comment) }}" :employees="{{ $employees }}" v-cloak></markdown-editor>
