    ...
    <div class="mw-100 d-flex flex-grow-1 p-3 align-items-center">
        ...
        <div class="d-none d-md-block ms-2">
            <div class="dropdown d-inline">
                <button class="btn btn-lg btn-link dropdown-toggle-vertical-points text-muted" type="button" id="wageServiceOverviewDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>

                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="wageServiceOverviewDropdown">
